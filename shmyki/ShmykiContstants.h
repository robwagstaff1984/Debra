...
#define JAVASCRIPT_RESTYLE_REVIEW_PAGE @"document.getElementById('bg').style['margin'] = '0px'; document.getElementById('ctl00_threecol1').style['padding'] = '0px'; document.getElementById('containerbottom').style['padding'] = '0px';  document.getElementById('footer').style['display'] = 'none'; document.getElementById('container').style['margin'] = '0px'; document.getElementById('container').style['padding'] = '0px'; document.getElementsByClassName('AspNet-Menu-Vertical')[0].style['display'] = 'none'; document.getElementById('containerthree').style['margin-left'] = '0px';document.getElementById('container').style['width'] = 'auto';document.getElementById('containerthree').style['width'] = 'auto';document.getElementById('containerbottom').style['width'] = 'auto';  document.getElementById('content').style['margin-right'] = '0px'; document.getElementById('content').style['margin-left'] = '0px'; document.getElementById('bg').style['width'] = '300px'; document.getElementById('content').style['width'] = '300px'; document.getElementById('progress').style['display'] = 'none'; document.getElementById('header').children[4].style['display'] = 'none'; document.getElementById('header').children[5].style['display'] = 'none'; document.getElementById('header').children[6].style['display'] = 'none'; document.getElementById('header').children[7].style['display'] = 'none'; document.getElementById('header').children[2].style['background-position-x'] = '74px'; document.getElementById('header').children[2].style['width'] = '320px'; var columnb = document.getElementById('columnb');if(columnb) {   columnb.style['display'] = 'none'; }"
