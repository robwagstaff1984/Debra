...
#define SECONDS_FOR_AMBER_POI 7200
...
#define JAVASCRIPT_CHOOSE_TOP_UP_MONEY_SUMBIT @"var submitButton = document.getElementById(\"ctl00_uxContentPlaceHolder_uxSubmit\"); submitButton.click();";
#define JAVASCRIPT_CHOOSE_TOP_UP_PASS_SUMBIT @"document.getElementById(\"ctl00_uxContentPlaceHolder_uxTopUpPass\").click(); var submitButton = document.getElementById(\"ctl00_uxContentPlaceHolder_uxSubmit\"); submitButton.click();";
...
#define JAVASCRIPT_SPECIFY_TOP_UP_PASS_AND_SUBMIT @"document.getElementById('ctl00_uxContentPlaceHolder_uxdays').value= '%@';document.getElementById('ctl00_uxContentPlaceHolder_uxZonelist')[%@-1].selected = 'selected'; document.getElementById('ctl00_uxContentPlaceHolder_uxZonesTo')[%@-1].selected = 'selected'; var submitButton = document.getElementById('ctl00_uxContentPlaceHolder_uxNext'); submitButton.click();"


#define JAVASCRIPT_RESTYLE_REVIEW_PAGE @"document.getElementById('bg').style['margin'] = '0px'; document.getElementById('ctl00_threecol1').style['padding'] = '0px'; document.getElementById('containerbottom').style['padding'] = '0px';  document.getElementById('footer').style['display'] = 'none'; document.getElementById('container').style['margin'] = '0px'; document.getElementById('container').style['padding'] = '0px'; document.getElementsByClassName('AspNet-Menu-Vertical')[0].style['display'] = 'none'; document.getElementById('containerthree').style['margin-left'] = '0px';document.getElementById('container').style['width'] = 'auto';document.getElementById('containerthree').style['width'] = 'auto';document.getElementById('containerbottom').style['width'] = 'auto';  document.getElementById('content').style['margin-right'] = '0px'; document.getElementById('content').style['margin-left'] = '0px'; document.getElementById('bg').style['width'] = '300px'; document.getElementById('content').style['width'] = '300px'; document.getElementById('header').children[4].style['display'] = 'none'; document.getElementById('header').children[5].style['display'] = 'none'; document.getElementById('header').children[6].style['display'] = 'none'; document.getElementById('header').children[7].style['display'] = 'none'; document.getElementById('header').children[2].style['background-position-x'] = '74px'; document.getElementById('header').children[2].style['width'] = '320px'; var columnb = document.getElementById('columnb');if(columnb) {   columnb.style['display'] = 'none'; } var progress = document.getElementById('progress');if(progress) {   progress.style['display'] = 'none'; } var cc1 = document.getElementById('ctl00_uxContentPlaceHolder_uxCreditCardNumber1'); if (cc1){ cc1.setAttribute('onkeyup', '');} var cc2 = document.getElementById('ctl00_uxContentPlaceHolder_uxCreditCardNumber2'); if (cc2){ cc2.setAttribute('onkeyup', '');} var cc3 = document.getElementById('ctl00_uxContentPlaceHolder_uxCreditCardNumber3'); if (cc3){ cc3.setAttribute('onkeyup', '');}"
...
#define MYKI_MONEY_TEXTFIELD_TAG 202
#define MYKI_PASS_DAYS_TEXTFIELD_TAG 203
#define MYKI_PASS_ZONE_FROM_TEXTFIELD_TAG 204
#define MYKI_PASS_ZONE_TO_TEXTFIELD_TAG 205
#define MYKI_MONEY_TEXTFIELD_CONTAINER_TAG 206
#define MYKI_PASS_DAYS_TEXTFIELD_CONTAINER_TAG 207
#define MYKI_PASS_ZONE_FROM_TEXTFIELD_CONTAINER_TAG 208
#define MYKI_PASS_ZONE_TO_TEXTFIELD_CONTAINER_TAG 209
